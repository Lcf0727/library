        ...
        <div class="panel-body">
            <form action="reader_edit_do_r.html" method="post" id="edit" >
                <div class="input-group">
                    <span  class="input-group-addon">学生证号</span>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="birth" id="birth"  value="<fmt:formatDate 
										value="${readerinfo.birth}" pattern="yyyy-MM-dd HH:mm:ss"/>" >
                </div>
                <div class="input-group">

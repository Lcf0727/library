...
<html>
<head>
    <title>编辑学生${readerInfo.readerId}信息</title>
...
<div class="col-xs-6 col-md-offset-3" style="position: relative;">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">编辑学生${readerInfo.readerId}信息</h3>
        </div>
            ...
            <form action="reader_edit_do.html?readerId=${readerInfo.readerId}" method="post" id="readeredit" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="birth" id="birth"  
                    	value="<fmt:formatDate value="${readerInfo.birth}" pattern="yyyy-MM-dd HH:mm:ss"/>" >
                </div>
                <div class="input-group">

...
<body background="img/timg.jpg"
	...
	<h2
		style="text-align: center; color: white; font-family: '华文行楷'; font-size: 500%">选课系统</h2>
	...
	<div class="panel panel-default" id="login">
		...
		<div class="panel-body">
			<div class="form-group">
				<label for="id">账号</label> <input type="text" class="form-control"
					id="id" placeholder="请输入账号">
			</div>
			<div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.stateCode.trim() === "0") {
                            ...
                            window.location.href="/mylibrary/admin_main.html";
                        } else if (data.stateCode.trim() === "2") {
                            $("#info").text("提示:登陆成功，跳转中...");
                            window.location.href="/mylibrary/reader_main.html";
                        }
                    }
                });
            }
